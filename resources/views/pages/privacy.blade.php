    ...
    <main class="py-12 mt-14 sm:mt-18 lg:py-20">
        <div class="max-w-6xl w-full px-6 mx-auto">
            <div class="single-post-content">
                <h1 class="wp-block-heading">Ochrana osobných údajov</h1>

                <p>Táto stránka obsahuje informácie o ochrane osobných údajov pre Movie Context.</p>

                <h2 class="wp-block-heading">1. Prevádzkovateľ osobných údajov</h2>
                <p>Movie Context s.r.o.<br>
                Adresa: Bratislava, Slovensko<br>
                IČO: TBD<br>
                Kontakt: info@moviecontext.sk</p>

                <h2 class="wp-block-heading">2. Aké údaje spracúvame</h2>
                <p>Spracúvame iba údaje, ktoré nám poskytnete pri registrácii alebo používaní našich služieb.</p>
            </div>
        </div>
    </main>
