    ...
    <main class="py-12 mt-14 sm:mt-18 lg:py-20">
        <div class="max-w-6xl w-full px-6 mx-auto">
            <div class="single-post-content">
                <h1 class="wp-block-heading">Obchodné podmienky</h1>

                <p>Tieto obchodné podmienky upravujú vzťahy medzi Movie Context a jeho používateľmi.</p>

                <h2 class="wp-block-heading">1. Všeobecné ustanovenia</h2>
                <p>Movie Context je platforma pre filmové recenzie a správy.</p>
            </div>
        </div>
    </main>
