...
<head>
    ...
    <meta name="description" content="{{ $description ?? 'Najnovšie filmové novinky, recenzie a správy z filmového sveta' }}">
    <link rel="canonical" href="{{ url()->current() }}">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="{{ $ogType ?? 'website' }}">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="{{ $ogTitle ?? ($title ?? 'Movie Context') }}">
    <meta property="og:description" content="{{ $ogDescription ?? ($description ?? 'Najnovšie filmové novinky, recenzie a správy z filmového sveta') }}">
    ...
    <meta property="twitter:title" content="{{ $twitterTitle ?? ($title ?? 'Movie Context') }}">
    <meta property="twitter:description" content="{{ $twitterDescription ?? ($description ?? 'Najnovšie filmové novinky, recenzie a správy z filmového sveta') }}">
    <meta property="twitter:image" content="{{ $twitterImage ?? ($ogImage ?? asset('images/og-homepage.jpg')) }}">
            ...
            <div class="flex flex-col items-center gap-6 py-8 lg:flex-row lg:justify-between">
                <div class="flex flex-col items-center gap-6 lg:flex-row">
                    ...
                    <ul class="flex flex-col items-center gap-2 sm:flex-row sm:gap-6">
                        <li>
                            <a href="{{ route('cookies') }}" class="text-sm underline text-gray-200 transition-colors duration-150 hover:text-green-400">Obchodné podmienky</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{ route('terms') }}" class="text-sm underline text-gray-200 transition-colors duration-150 hover:text-green-400">Cookies</a>
                        </li>
                    </ul>
                </div>
            </div>
